            ...
            <div className="flex flex-col md:flex-row items-center gap-x-8 h-full px-16 ">
              ...
              <div className="w-full max-w-[300px] flex flex-col xl:justify-center items-center mx-auto xl:mx-0">
                <div className="flex flex-col justify-center text-center">
                  ...
                  {/* positions */}
                  <div className="text-[12px] uppercase tracking-widest font-extralight">{person.position}</div>
                </div>
              </div>
              {/* quote & message */}
              <div className="flex-1 flex flex-col justify-center before:w-[1px] xl:before:bg-white/20 xl:before:absolute xl:before:left-0 xl:before:h-[200px] relative xl:pl-20">
                {/* quote icon */}
                <div><FaQuoteLeft className="text-4xl xl:text-6xl text-white/30 mx-auto md:mx-0" /></div>
                {/* message */}
